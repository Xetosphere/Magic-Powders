...
import net.blazecoding.magicpowders.recipe.AlchemyCraftingManager;
...
public class ContainerAlchemistTable extends Container {
	...
	public ContainerAlchemistTable(InventoryPlayer par1InventoryPlayer, World par2World, int par3, int par4, int par5) {
		...
		this.addSlotToContainer(new SlotAlchemistTable(par1InventoryPlayer.player, this.craftMatrix, this.craftResult, 0, 124, 35));
