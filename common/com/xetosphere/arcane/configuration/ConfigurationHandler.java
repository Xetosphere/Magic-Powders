...
public class ConfigurationHandler {
	...
	public static void init(File configFile) {
		...
		try {
			...
			ItemIDs.METAL_DUSTS = config.getItem(Configuration.CATEGORY_ITEM, Strings.METAL_DUST_NAME, ItemIDs.METAL_DUST_DEFAULT).getInt(ItemIDs.METAL_DUST_DEFAULT);
			ItemIDs.RECIPE_SCROLL = config.getItem(Configuration.CATEGORY_ITEM, Strings.RECIPE_SCROLL_NAME, ItemIDs.RECIPE_SCROLL_DEFAULT).getInt(ItemIDs.RECIPE_SCROLL_DEFAULT);
			ItemIDs.STUDDED_PAPER = config.getItem(Configuration.CATEGORY_ITEM, Strings.STUDDED_PAPER_NAME, ItemIDs.STUDDED_PAPER_DEFAULT).getInt(ItemIDs.STUDDED_PAPER_DEFAULT);
			ItemIDs.RUNE_SYMBOLS = config.getItem(Configuration.CATEGORY_ITEM, Strings.RUNE_SYMBOLS_NAME, ItemIDs.RUNE_SYMBOLS_DEFAULT).getInt(ItemIDs.RUNE_SYMBOLS_DEFAULT);
			ItemIDs.RUNE_BASE = config.getItem(Configuration.CATEGORY_ITEM, Strings.RUNE_BASE_NAME, ItemIDs.RUNE_BASE_DEFAULT).getInt(ItemIDs.RUNE_BASE_DEFAULT);
