...
public class ConfigurationHandler {
	...
	public static void init(File configFile) {
		...
		try {
			...
			BlockIDs.ARCANE_INFUSER = config.getBlock(Configuration.CATEGORY_BLOCK, Strings.ARCANE_INFUSER_NAME, BlockIDs.ARCANE_INFUSER_DEFAULT).getInt(BlockIDs.ARCANE_INFUSER_DEFAULT);
