...
public class ConfigurationHandler {
	...
	public static void init(File configFile) {
		...
		try {
			...
			ItemIDs.RECIPE_PAPER = config.getItem(Configuration.CATEGORY_ITEM, Strings.RECIPE_PAPER_NAME, ItemIDs.RECIPE_PAPER_DEFAULT).getInt(ItemIDs.RECIPE_PAPER_DEFAULT);
