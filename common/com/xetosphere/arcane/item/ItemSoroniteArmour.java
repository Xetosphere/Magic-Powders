...
public class ItemSoroniteArmour extends ItemArmor {

	public ItemSoroniteArmour(int id, EnumArmorMaterial armourMaterial, int renderIndex, int armourPart) {
	...
	public String getArmorTexture(ItemStack stack, Entity entity, int slot, String type) {
		if (slot == 0 || slot == 1 || slot == 3) {
			return Strings.RESOURCE_PREFIX + Textures.ARMOR_SHEET_LOCATION + Strings.SORONITEARMOUR_NAME + "_1.png";
		} else if (slot == 2) {
			return Strings.RESOURCE_PREFIX + Textures.ARMOR_SHEET_LOCATION + Strings.SORONITEARMOUR_NAME + "_2.png";
		}
		return null;
	}
